...
public class AlarmCursorAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return LayoutInflater.from(context).inflate(R.layout.fragment_alarm, parent, false);
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (time != null){
            ...
            mDateAndTimeText.setText("โปรดตั้งเวลาแจ้งเตือน");
        }
        ...
        if(repeat != null){
            ...
            mRepeatInfoText.setText("การแจ้งเตือนซ้ำถูกปิด");
        }
    ...
    public void setReminderRepeatInfo(String repeat, String repeatNo, String repeatType) {
        if(repeat.equals("true")){
            mRepeatInfoText.setText("แจ้งเตือนทุกๆ " + repeatNo + " " + repeatType + "(s)");
        }else if (repeat.equals("false")) {
            mRepeatInfoText.setText("ปิดการแจ้งเตือนซ้ำ");
        }
    }
